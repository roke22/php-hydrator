...
namespace Roke\ArrayToObjectFactory;

use ReflectionClass;
use Roke\ArrayToObjectFactory\Support\ClasesStyles;
...
class ArrayToObject
{
    ...
    protected static function createObject(array $data, $constructor)
    {
        ...
        foreach ($constructor->getParameters() as $parameter) {
            ...
            if (in_array($parameter->getType()->getName(), ['string', 'int', 'bool', 'float']) === true) {
            ...
            if (in_array($parameter->getType()->getName(), ['array']) === true) {
            ...
            if (in_array($parameter->getType()->getName(), ['string', 'int', 'bool', 'float', 'array']) === false) {
